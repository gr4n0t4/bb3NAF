...
def test_pdm():
    ...
    return render_template('test.html', resultados=resultados, entrenadores=entrenadores_array, titulo="Open season 5 (test)", num_entrenadores=len(num_entrenadores), page=0, total=0)
